...
## Reach Goals
I would like to turn batch processing into valid usable CUDA C++ code, to allow workloads to be parallelized and ran on the GPU. Equivalently, multi-threading could also be a reach goal for CPU parallelization.
